...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const SummFactory = await deploy("SummFactory", {
    //  - hardhat is smart enough to look into contracts for a contract with this name and it takes care of buisness
  ...
  log(`SummFactory deployed to: ${SummFactory.address} on ${network.name} network.`);
